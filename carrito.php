                    ...
                    foreach ($carrito as $idProducto => $cantidad) {
                        ...
                        ?>    
                            <tr>
                                ...
                                <td><a class="text-decoration-none" href="procesaCarrito.php?idProducto=<?= $idProducto ?>&operacion=remove">-</a> <?= $cantidad ?> <a class="text-decoration-none" href="procesa-carrito.php?idProducto=<?= $idProducto ?>&operacion=add">+</a></td>
                                <td><?= $precio ?>€</td>
                                <td><?= $subtotal ?>€</td>
                            </tr>
